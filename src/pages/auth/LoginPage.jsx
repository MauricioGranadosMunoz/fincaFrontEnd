...
import { loginUsuario } from "../../store/slices/Usuario";
...
export const LoginPage = () => {
  ...
  const { US_CORREO, US_CONTRASENA, onInputChange, formState } = useForm({
    US_CORREO: "mgranadosmunoz@gmail.com",
    US_CONTRASENA: "Mg110101",
  });
  ...
  return (
    <div className="login-container">
      <div className="box-login left">
        <img alt='d' src="https://res.cloudinary.com/ctp-san-pablo/image/upload/v1670794815/login-ilustracion.svg" />
      </div>
